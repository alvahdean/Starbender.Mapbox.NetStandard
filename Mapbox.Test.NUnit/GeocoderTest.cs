...
namespace Mapbox.UnitTest
{
    ...
    internal class GeocoderTest
    {
        ...
        private readonly string forwardResponse =
        ...
        private readonly string reverseResponse =
        ...
        public void SerializesAndDeserializesReverse()
        {
            ...
            ReverseGeocodeResponse reverseResp =
                this.geocoder.Deserialize<ReverseGeocodeResponse>(this.reverseResponse);
