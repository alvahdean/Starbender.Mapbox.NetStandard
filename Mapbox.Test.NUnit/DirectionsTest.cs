...
namespace Mapbox.UnitTest
{
    ...
    internal class DirectionsTest
    {
        ...
        [Test]
        [Ignore(
            "That's not working as the order of JSON properties is not guaranteed. We need a proper object comparer.")]
