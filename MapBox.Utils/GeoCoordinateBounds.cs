...
namespace Mapbox.Utils
{
    ...
    public struct Vector2dBounds
    {
        ...
        public bool IsEmpty()
        {
            return this.SouthWest.x > this.NorthEast.x || this.SouthWest.y > this.NorthEast.y;
        }
        ...
        {
            double[] array = { this.SouthWest.x, this.SouthWest.y, this.NorthEast.x, this.NorthEast.y };
